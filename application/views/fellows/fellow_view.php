	                      	...
	                      	<div class="row">
	                        		...
	                        		<div class="panel panel-default">
		                                <div class="panel-body">
		                                	<p class="lead no-bottom">
		                                		<?php echo $fellow->firstname . " " . $fellow->lastname?>
		                                		<!-- This is a link to the Program page for the residents Residency program -->
		                                		<span class="pull-right"><?php echo $fellow->program_name?></span>
		                                	</p>
		                                </div>
	                              	</div>
	                        	</div>
	                        	...
	                        	<div class ="col-sm-6">
	                        		...
	                        		<div class="panel panel-default">
		                                ...
		                                <p class="top-spacer"> <b> Email: </b> <?php echo $fellow->email ?> </p>
		                                <p> <b> Telephone: </b> <?php echo $fellow->telephone ?> </p>
		                                <p> <b> Year as Fellow: </b> <?php echo $fellow->year_attended ?> </p>
		                                </div>
	                              	</div>
	                        		...
	                        		<div class="panel panel-default">
		                        		<div class="panel-body">
		                        			...
		                        			<?php
		                        				/*foreach($fellow->notes as $key => $value)
		                        				{
					        ...
					        <div class="modal-content">
					            <div class="modal-header">
						            ...
						            <div class="modal-body col-xs-10 col-xs-offset-1">
						            	<div class = "panel panel-default top-spacer">
											<div class="panel-body text-center">
												<form id="addNoteForm" action = '<?php echo base_url() . "residents/addNote/" . $fellow->getID()?>' method="post">
								            	<div id="noteBox">
	...
	<script> 
		$(document).on("click","#findCourseBtn",function(){
			...
			$.ajax({
			  ...
			  dataType: "html",
			  data: {residentID : <?php echo $fellow->getID() ?>}, 
