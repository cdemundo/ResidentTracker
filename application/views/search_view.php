...
<div class="wrapper">
		                        	...
		                        	<div class = "col-sm-12">
		                        		...
		                        		<div class="panel panel-default">
			                                <div class="panel-body">
			                                  <h4 class = "text-center bottom-spacer"> Search </h4>
			                                  <div class="text-center">
			                                  	  <select id = "searchFor" class="selectpicker"> 
	...
	<script>
		$('#searchForm').submit(function( event ) {
			...
			//searching for a resident or fellow?
			...
			$.ajax({
			  type: "POST",
			  url: base_url + searchFor + '/lastNameSearch/' + $('#lastName').val(),
			  dataType: "html",
