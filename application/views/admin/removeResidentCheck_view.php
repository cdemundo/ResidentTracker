		                        	...
		                        	<div class = "col-sm-12">
		                        		...
		                        		<div class="panel panel-default">
			                                <div class="panel-body">
			                                	<h4 class="text-center"> Remove Resident? </h4>	
			                                	<h5 class="text-center"> Cannot be undone </h5>			                                  
			                                </div>
			                                	...
			                                	<div class = "panel panel-default">
													<div class="panel-body text-center">
														<div class = "col-sm-4 col-sm-offset-4 text-center">
															<form id="removeResidentForm" action="<?php echo base_url()?>admin/removeResident" method="post"> 
																<?php 
							                                	...
							                                	?>
							                                <input type="hidden" name = "residentID" value = "<?php echo $residentToRemove->getID() ?>" />
